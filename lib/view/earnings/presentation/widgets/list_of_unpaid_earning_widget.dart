...
class ListOfUnPaidEarningWidget extends StatefulWidget {
  const ListOfUnPaidEarningWidget({
    Key? key,
  }) : super(key: key);

  @override
  State<ListOfUnPaidEarningWidget> createState() =>
      _ListOfUnPaidEarningWidgetState();
}

class _ListOfUnPaidEarningWidgetState extends State<ListOfUnPaidEarningWidget> {
                      ...
                      builder:
                        ...
                        if (snapshot.connectionState ==
                          ...
                          List<EmployeeInvoic> paidInvoices = invoices
                              .employeeInvoic
                            .reversed  .where((invoice) => invoice.status == 'unpaid')
                              .toList();
