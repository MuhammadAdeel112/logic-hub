...
class MyApprovedJobWidget extends StatefulWidget {
  const MyApprovedJobWidget({Key? key}) : super(key: key);

  @override
  State<MyApprovedJobWidget> createState() => _MyApprovedJobWidgetState();
}

class _MyApprovedJobWidgetState extends State<MyApprovedJobWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    assignedJobs?.where((job) => job.approvalStatus == 'approved').toList();
          ...
          case Status.COMPLETED:
            if (initialJobList == null || initialJobList.isEmpty) {
              return const ResueAbleErrorScreen(
                errorMsg:
                'No Approved jobs yet. Once your completed jobs are approved by Manager, they will appear here.',
              );
            }
